...
(function() {
	...
	/**
	 * Same as core.util.TextCompressor but generates only safe UTF16 characters
	 * so e.g. embedding into XML works.
	 * This uses Base32k encoding.
	 *
	 * This is slightly more inefficient in speed (~ +20%) and size (~ +7%) than TextCompressor
	 */
	core.Module("core.util.SafeTextCompressor", {
		/**
		 * {String} Returns packed UTF16 representation of given encoded @text {String}.
		 */
		compress : context.base32k.encodeBytes,
		/**
		 * {String} Returns unpacked string representation of given @encodedText {String}.
		 */
		decompress : context.base32k.decodeBytes
	});
})();
