...
core.Module("core.detect.Locale",
  {
    ...
    VALUE : (function(global)
    {
      ...
      if (qs.indexOf('partner=60') > -1 ||
        ...
        return 'it';
      } else if (qs.indexOf('partner=91') > -1 ||
        qs.indexOf('partner=libraccioit') > -1 ||
        (global.sessionStorage && global.sessionStorage.getItem('master') === 'libraccioit')) {
        // We need Libraccio.it to always be in Italian
        return 'it';
      }
      // [HACK] end
